...
class Field(object):
    ...
    def validate(self, value):
        ...
        return value
    def validate_try(self, value):
        """Convenience function returning a boolean indicating valid or not.
        Use validate to get a valid value, raising excepption if invalid."""
        try:
            self.validate(value)
            return True
        except ValueError:
