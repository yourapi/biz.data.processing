from indroid.app.config import Config
import sys, logging
...
class App(object):
    ...
    def run(self):
        ...
        from indroid.plumbing.threading import Factory # Import module locally, because all mdules import the App-module and otherwise circular refenerces are created!
