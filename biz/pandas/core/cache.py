import numpy as np
from biz.metadata.types import Types
...
from biz import types, pandas as pd, pandas
...
class read_source(object):
    ...
    def __init__(self, level_last=None, filename=None, levels=None, 
        ...
        from biz.pandas.core.collect import file_date   # Do it here; at module-level a circular reference is created    
...
def test_ip():
    ...
    src = biz.pandas.read_source(levels='/source/kpn/swol_marketing', pipeline=['input', 'map'], to_cache=False, merge_sources=True)    
